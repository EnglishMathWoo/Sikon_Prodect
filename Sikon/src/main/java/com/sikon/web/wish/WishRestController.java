...
import com.sikon.service.wish.WishService;
	...
	public String updateWish(@RequestParam("wishNo") int wishNo, @RequestParam("cookStatus") int cookStatus)
			throws Exception {
	...
	public Map addWish(@RequestParam("cookStatus") int cookStatus, @RequestParam("cookNo") int cookNo,
