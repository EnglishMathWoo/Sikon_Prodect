		  ...
		  <div class="row">
			<c:set var="i" value="${ i+1 }" />
			  ...
			  <div class="col-md-1 text-center">
			  	...
			  	<input type="hidden" name="cookNo" value="${heart.cookNo}"/>
			  ...
			  <c:choose>
				    ...
				    <c:otherwise>
						<img src="/images/uploadFiles/${cook.cookFilename}" class="img-responsive img-rounded" class="image" width="100" height="100">
					</c:otherwise>
				</c:choose>
				
			  </div>	 
			    <div align="center" class="col-md-2 text-center buy" value="${cook.hearthit}">
			  ...
			  <div align="center" class="col-md-2 text-center buy" value="${cook.cookStatus }">
			  ...
			  <div align="center" class="col-md-2 text-center price" value="${heart.cookPrice }" >
			  ${heart.cookPrice} 원
			  </div>
			  	...
			  	<button type="button" class="btn btn-primary btn-sm delete" value="${heart.heartNo}">삭제</button>
           </div>
           <hr/>
          </c:forEach>
