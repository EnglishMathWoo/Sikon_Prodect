			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<select name="recipeTheme" class="form-control" id="recipeTheme" required>
						...
						<option value="한식"  ${!empty recipe.recipeTheme && recipe.recipeTheme=="한식" ? "selected" : ""}>한식</option>
						<option value="중식"  ${!empty recipe.recipeTheme && recipe.recipeTheme=="중식" ? "selected" : ""}>중식</option>
						<option value="양식"  ${!empty recipe.recipeTheme && recipe.recipeTheme=="양식" ? "selected" : ""}>양식</option>
						<option value="일식"  ${!empty recipe.recipeTheme && recipe.recipeTheme=="일식" ? "selected" : ""}>일식</option>
						<option value="간식"  ${!empty recipe.recipeTheme && recipe.recipeTheme=="간식" ? "selected" : ""}>간식</option>
					</select>
				</div>
			</div>
