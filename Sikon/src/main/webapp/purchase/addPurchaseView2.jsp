...
<form>
  ...
  <div class="form-group">
    ...
    <label for="prodName">받는분 이름</label>
      <input type="text" id="receiverName" class="floatLabel" name="receiverName" value="${user.userName}">
    </div>
    
	<div class="controls">
	<label for="prodName">연락처</label>
	     <input type="text" id="receiverPhone" class="floatLabel" name="receiverPhone" value="${user.phone}">
    </div>
   ...
   <div class="controls">
	<label for="prodName">이메일</label>
	     <input type="text" id="receiverEmail" class="floatLabel" name="receiverEmail" value="${user.phone}">
    </div>
    </c:if>
 ...
 <br>
  ...
  <h2 class="heading"></h2>
  	...
  	<button type="button" class="size submit" id="iamportPayment">구매하기</button> &nbsp;
