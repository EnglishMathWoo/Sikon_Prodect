					...
					<c:choose>
					 ...
					 <c:choose>
					 	<c:when test="${purchase.divyStatus.equals('003') && purchase.reviewStatus.equals('001')}">
					 		<td class="rev"><button type="button" class="review"  onclick="window.open('/review/addReview.jsp?category=PRD&textNo=${purchase.purchaseProd.prodNo}', 'review', 'width=430, height=525, location=no, status=no, scrollbars=yes');">리뷰쓰기</button></td>
					 	</c:when>
					 	<c:otherwise>
					 		<td class="rev"></td>
					 	</c:otherwise>
			  		...
			  		<c:if test="${ before eq after }">
					  	<tr>
							...
							<c:choose>
							 ...
							 <c:choose>
							 	<c:when test="${purchase.divyStatus.equals('003') && purchase.reviewStatus.equals('001')}">
							 		<td class="rev"><button class="review"  onclick="window.open('/review/addReview.jsp?category=PRD&textNo=${purchase.purchaseProd.prodNo}', 'review', 'width=430, height=525, location=no, status=no, scrollbars=yes');">리뷰쓰기</button></td>
							 	</c:when>
							 	<c:otherwise>
							 		<td class="rev"></td>
							 	</c:otherwise>
					...
					<c:if test="${ before ne after }">
					  	...
					  	<tr>
							...
							<c:choose>
							 ...
							 <c:choose>
							 	<c:when test="${purchase.divyStatus.equals('003') && purchase.reviewStatus.equals('001')}">
							 		<td class="rev"><button class="review">리뷰쓰기</button></td>
							 	</c:when>
							 	<c:otherwise>
							 		<td class="rev"></td>
							 	</c:otherwise>
