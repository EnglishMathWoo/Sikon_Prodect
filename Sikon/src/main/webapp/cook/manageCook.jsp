...
<script type="text/javascript">
	function fncGetList(currentPage) {
		...
		$("form").attr("method", "POST").attr("action", "/cook/manageCook")
				.submit();
	}
		...
		$(".delete")
				.on(
						...
						function() {
							...
							$("input[name='cookCheck']:checked").each(
									function() {
							...
							if (checkCount != 0) {
								...
								self.location = "/cook/deleteCook?checkCount="
										+ checkCount + "&checkList=" + array;
							}
	...
	<div class="container list">
		...
		<form class="form-inline" name="detailForm">
			...
			<div class="row">
				<table width="100%">
					<tr>
						<td class="col-md-6 text-right"><input type="hidden" name="searchCondition" id="searchCondition" value="">
							<div class="form-group">
								<label class="sr-only" for="searchKeyword">검색</label> <input type="text" style="display: none;">
							...
							<button type="button" class="btn btn-default" id="search">검색</button></td>
					</tr>
				</table>
			</div>
			<div class="row">
