...
<body>
	...
	<div class="container">
		...
		<div class="layout">
			<h1 class="bg-defualt text-center">쿠킹클래스 신청</h1>
			<br>
			...
			<form class="form-horizontal">
				...
				<br> <input type="hidden" id="userName" value="${user.userName }" />
				<div class="form-group">
					<label for="userName" class="form-control">신청자이름</label> <input type="text" class="form-control" id="userName" name="userName" placeholder="구매자이름" value="${user.userName}">

				</div>

				<input type="hidden" id="phone" value="${user.phone }" />
				<div class="form-group">
					<label for="phone" class="form-control">신청자연락처</label> <input type="text" class="form-control" id="phone" name="phone" placeholder="신청자연락처" value="${user.phone}">
					...
					<c:forEach var="wish" items="${wishlist}">
						<div class="form-group">
							<table style="width: 100%">
								<tr>
									<td class="imagetd"><c:forEach var="name" items="${wish.wishCook.cookFilename.split('/')[0]}">
									...
									<td class="content">
										...
										</p> <input type="hidden" id="cookStatus" value="${wish.cookStatus }" />
										<p>신청인원 :&emsp; ${wish.cookStatus}명</p>
										<p>수업시간 :&emsp; ${wish.wishCook.startTime}&emsp;~&emsp; ${wish.wishCook.endTime}</p>
									</td>
								</tr>
							</table>
						</div>
				...
				<input type="hidden" id="cookStock" value="${cook.cookStock }" /> <br>
				...
				<div class="form-group">
					<ul class="payul">
						<li><input type="radio" name="payoption" id="paybyca" checked /> <span style="font-size: 16px; font-weight: bold;">신용카드</span></li>
						<li><input type="radio" name="payoption" /> <img src="https://storage.wcuisine.net/web-assets/images/img-pay-kakao@3x.png" alt="kakaopay icon" width="58" height="24"></li>
					</ul>
				</div>
				<input type="hidden" name="impNumber" id="impNumber" value=""> <input type="hidden" name="paymentOpt" id="paymentOpt" value="">

			</form>

			<input type="hidden" id="userId" value="${user.userId }" /> <input type="hidden" id="userName" value="${user.userName }" /> <input type="hidden" id="phone" value="${user.phone }" /> <br>
