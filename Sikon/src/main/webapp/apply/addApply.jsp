	...
	<div class="container">
		...
		<div class="layout">
			...
			<form class="form-horizontal">
					...
					<div class="form-group">
						<table style="width: 100%">
							<tr>
								...
								<td class="imagetd"><img src="/resources/images/uploadFiles/${cook.cookFilename}" width="300" height="300" align="absmiddle" /></td>
				...
				<div class="form-group">
					<label for="text">수업시간 :&emsp;</label> <strong> ${cook.startTime}&emsp;~&emsp; ${cook.endTime}</strong>
				...
				<div class="form-group">
					...
					<strong>
						<p>신청인원: ${cookStatus} 명</p>
						<input type="hidden" min="0" class="form-control" id="cookStatus" name="cookStatus" value="${cookStatus}" />
					</strong>
				</div>
			  ...
			  <input type="hidden" id="cookPrice" value="${cook.cookPrice }" />
			   <input type="hidden" id="phone" value="${user.phone }" />
			    <input type="hidden" id="userName" value="${user.userName }" />
			     <input type="hidden" id="userId" value="${user.userId }" />
			      <input type="hidden" id="cookLocation" value="${cook.cookLocation }" /> <br>
