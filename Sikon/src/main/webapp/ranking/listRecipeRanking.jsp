	...
	<div class="container">
		...
		<div class="wrapper row3">
			...
			<section class="hoc container clear">
				<div class="center btmspace-50">
					<br />
					<div class="font-x2 nospace" align="center"
						style="color: #937062; font-size: 35px">
						<br> RANKING
					</div>
					<div align="center" style="color: #937062; font-size: 18px;">
						<br> TOP 20
					</div>
				</div>
				...
				<form class="form-inline" name="detailForm">
					...
					<nav class="ref-sort">
						...
						<input type="hidden" id="orderCon"
							value="${search.orderCondition}" />
		...
		<div class="row">
					...
					<div class="col-sm-6 col-md-3">
						...
						<div id="latest" class="group">
							<article class="one_third first">
								<a class="imgover" value="${recipe.recipeNo }"> <c:choose>
										<c:when test="${recipe.recipeImg.contains('mp4')}">
											<video width="250" height="250" controls autoplay
												src="/resources/images/uploadFiles/${recipe.recipeImg }"
												type="video/mp4"></video>
										</c:when>
										<c:otherwise>
											<img src="/resources/images/uploadFiles/${recipe.recipeImg }"
												width="320" height="300" id="image">
										</c:otherwise>
									</c:choose>
								</a>
								<div class="best_label">
									<span style="margin-bottom: 8px;">${i}</span>
								</div>
			...
			<c:if test="${empty list}">
				...
				<br>
				<br>
				<h2 id="noRanking" style="text-align: center; font-weight: bold;">랭킹
					정보가 없습니다.</h2>
				<br>
			</c:if>
