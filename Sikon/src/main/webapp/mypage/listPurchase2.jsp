			...
			<tr>
			  ...
			  <c:when test="${purchase.divyStatus.equals('002')}">
				...
				<c:otherwise>
					...
					<a onclick="window.open('/review/addReview.jsp?category=PRD&textNo=${purchase.purchaseProd.prodNo }&textNo2=${purchase.tranNo}', 'review', 'width=430, height=525, location=no, status=no, scrollbars=yes');">리뷰쓰기</a>					
					</c:if>
					</td>
